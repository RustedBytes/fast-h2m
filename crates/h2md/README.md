...
[![Crates.io](https://img.shields.io/crates/v/h2md.svg?color=007ec6)](https://crates.io/crates/h2md)
[![npm version](https://img.shields.io/npm/v/@kreuzberg/h2md.svg?logo=npm&color=007ec6)](https://www.npmjs.com/package/@kreuzberg/h2md-node)
[![PyPI version](https://img.shields.io/pypi/v/h2md.svg?logo=pypi&color=007ec6)](https://pypi.org/project/h2md/)
[![Gem Version](https://img.shields.io/gem/v/h2md.svg?color=007ec6)](https://rubygems.org/gems/h2md)
[![Packagist](https://img.shields.io/packagist/v/kreuzberg-dev/h2md.svg?color=007ec6)](https://packagist.org/packages/kreuzberg-dev/h2md)
[![docs.rs](https://img.shields.io/badge/docs.rs-html--to--markdown--rs-007ec6)](https://docs.rs/h2md)
[![License: MIT](https://img.shields.io/badge/License-MIT-007ec6)](https://github.com/kreuzberg-dev/h2md/blob/main/LICENSE)
...
let options = ConversionOptions {
    ...
    newline_style: h2md::NewlineStyle::Backslash,
    code_block_style: h2md::CodeBlockStyle::Backticks,
    ..Default::default()
};
...
```rust
use h2md::{convert, ConversionOptions};
...
```rust
use h2md::{convert, ConversionOptions, PreprocessingOptions};

let mut options = ConversionOptions::default();
options.preprocessing.enabled = true;
options.preprocessing.preset = h2md::PreprocessingPreset::Aggressive;
...
```rust
use h2md::{convert, ConversionOptions, MetadataConfig};
...
```rust
use h2md::{convert, ConversionOptions};
use h2md::visitor::{HtmlVisitor, NodeContext, VisitResult};
...
- **JavaScript/TypeScript**: [h2md-node](https://github.com/kreuzberg-dev/h2md/tree/main/crates/h2md-node) (NAPI-RS) or [h2md-wasm](https://github.com/kreuzberg-dev/h2md/tree/main/crates/h2md-wasm) (WebAssembly)
- **Python**: [h2md](https://github.com/kreuzberg-dev/h2md/tree/main/crates/h2md-py) (PyO3)
- **PHP**: [h2md](https://github.com/kreuzberg-dev/h2md/tree/main/packages/php) (PIE + Composer helpers)
- **Ruby**: [h2md](https://github.com/kreuzberg-dev/h2md/tree/main/packages/ruby) (Magnus + rb-sys)
- **CLI**: [h2md-cli](https://github.com/kreuzberg-dev/h2md/tree/main/crates/h2md-cli)

## Documentation

- [Full Documentation](https://docs.h2md.kreuzberg.dev)
- [API Reference](https://docs.rs/h2md)
- [Documentation](https://docs.h2md.kreuzberg.dev/)
- [Contributing Guide](https://github.com/kreuzberg-dev/h2md/blob/main/CONTRIBUTING.md)
