...
impl TextDirection {
    ...
    ///
    /// ```
    /// # use h2md::metadata::TextDirection;
...
///
/// ```
/// # use h2md::metadata::DocumentMetadata;
...
///
/// ```
/// # use h2md::metadata::HeaderMetadata;
...
///
/// ```
/// # use h2md::metadata::{LinkMetadata, LinkType};
...
///
/// ```
/// # use h2md::metadata::{ImageMetadata, ImageType};
...
///
/// ```
/// # use h2md::metadata::{StructuredData, StructuredDataType};
...
///
/// ```
/// # use h2md::metadata::HtmlMetadata;
