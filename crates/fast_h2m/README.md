...
[![Crates.io](https://img.shields.io/crates/v/fast_h2m.svg?color=007ec6)](https://crates.io/crates/fast_h2m)
[![npm version](https://img.shields.io/npm/v/@kreuzberg/fast_h2m.svg?logo=npm&color=007ec6)](https://www.npmjs.com/package/@kreuzberg/fast_h2m-node)
[![PyPI version](https://img.shields.io/pypi/v/fast_h2m.svg?logo=pypi&color=007ec6)](https://pypi.org/project/fast_h2m/)
[![Gem Version](https://img.shields.io/gem/v/fast_h2m.svg?color=007ec6)](https://rubygems.org/gems/fast_h2m)
[![Packagist](https://img.shields.io/packagist/v/kreuzberg-dev/fast_h2m.svg?color=007ec6)](https://packagist.org/packages/kreuzberg-dev/fast_h2m)
[![docs.rs](https://img.shields.io/badge/docs.rs-html--to--markdown--rs-007ec6)](https://docs.rs/fast_h2m)
[![License: MIT](https://img.shields.io/badge/License-MIT-007ec6)](https://github.com/kreuzberg-dev/fast_h2m/blob/main/LICENSE)
...
- **JavaScript/TypeScript**: [fast_h2m-node](https://github.com/kreuzberg-dev/fast_h2m/tree/main/crates/fast_h2m-node) (NAPI-RS) or [fast_h2m-wasm](https://github.com/kreuzberg-dev/fast_h2m/tree/main/crates/fast_h2m-wasm) (WebAssembly)
- **Python**: [fast_h2m](https://github.com/kreuzberg-dev/fast_h2m/tree/main/crates/fast_h2m-py) (PyO3)
- **PHP**: [fast_h2m](https://github.com/kreuzberg-dev/fast_h2m/tree/main/packages/php) (PIE + Composer helpers)
- **Ruby**: [fast_h2m](https://github.com/kreuzberg-dev/fast_h2m/tree/main/packages/ruby) (Magnus + rb-sys)
- **CLI**: [fast_h2m-cli](https://github.com/kreuzberg-dev/fast_h2m/tree/main/crates/fast_h2m-cli)

## Documentation

- [Full Documentation](https://docs.fast_h2m.kreuzberg.dev)
- [API Reference](https://docs.rs/fast_h2m)
- [Documentation](https://docs.fast_h2m.kreuzberg.dev/)
- [Contributing Guide](https://github.com/kreuzberg-dev/fast_h2m/blob/main/CONTRIBUTING.md)
